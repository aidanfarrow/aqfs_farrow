...
setenv SMK_DEFAULT_TZONE    0   # default time zone for sources not in the COSTCY file
...
## For Elevpoint
setenv SMK_ELEV_METHOD      0   # 1 uses PELVCONFIG file to determine elevated sources
#      IOAPI_ISPH       set by Assigns file
...
setenv SMK_SPECELEV_YN      N   # Y uses the PELV file to set elevated sources
